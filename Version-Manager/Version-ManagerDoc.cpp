...
// Version-ManagerDoc.cpp : implementation of the CVersionManagerDoc class
//
...
// CVersionManagerDoc construction/destruction
...
void CVersionManagerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CVersionManagerDoc::InitializeSearchContent()
{
...
void CVersionManagerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CVersionManagerDoc diagnostics
