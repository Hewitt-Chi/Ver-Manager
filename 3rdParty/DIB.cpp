...
//BOOL CDib::Draw( CPaintDC &pDC, int nX, int nY, int nWidth, int nHeight )
...
unsigned char * CDib::GetDIBRowData()
{
    return m_pDibBits;
}

bool CDib::GetDIBArea(long &Width,long &Height)
{
    if ( m_pBIH == NULL) return false;
