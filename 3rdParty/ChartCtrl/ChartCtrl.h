...
public:
	...
	**/
	...
	void SetChartRect(CRect ARect[], int ARectSize);
    void GetBarCharValue(double *AValue);
	int GetRectID(CPoint APoint);
	void SetBarChart(CChartBarSerie *ABarChart, int ABarSize);
	bool IsUpdataEnable();
...
private:
	...
	**/
	...
	CRect       m_RecipeChartRect[10];
	CPoint      m_SelectRecipeBarPoint;
	int         m_BarSize;
    double      m_ArmRecipeValue[10];
	CChartBarSerie   *m_RecipeBarChart;

	bool        m_IsEnableUpData;
};
