...
COLORREF GetColorRef(ITEM_COLOR lParam)    
{
        switch (lParam)
        {
            ...
            case BBLACK:         return RGB(0,0,0);break; //black
            case BBLUE:          return RGB(0,0,255);break; //blue
            case GGREEN:         return RGB(0,255,0);break; //green
            case CYAN:          return RGB(0,255,255);break; //cyan
            case RRED:           return RGB(255,0,0);break; //red
            case MANGENTA:      return RGB(255,0,255);break; //mangenta
            case YELLOW:        return RGB(255,255,0);break; //yellow
            case WWHITE:         return RGB(255,255,255);break; //white
            ...
            case LLIGHTBLUE:     return RGB(166,202,240);break; //light-blue
            case DARKWHITE:     return RGB(255,251,240);break; //dark-white
            case MIDDLEGRAY:    return RGB(160,160,164);break; //middle-gray
            case DARKRED:        return RGB(96, 0, 0);break; //dark-red
            case LLIGHTRED:        return RGB(255,220,220);break; //Pink
            case LightPink:     return RGB(255,170,255);break;
